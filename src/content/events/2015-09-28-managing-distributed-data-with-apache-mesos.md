...
pres_url: >-
  https://events.linuxfoundation.org/events/apache-big-data-europe/program/schedule
start_date: 2015-09-28T00:00:00.000Z
slides_url: 'https://www.dropbox.com/s/js2j29krgrjf43s/Mesos%20Preso.key?dl=0'
summary: >-
  Apache Mesos is a fantastic tool for abstracting CPU, memory, storage, and
  other compute resources away from machines (physical or virtual). Alongside
  these features is Mesos-DNS, which provides service discovery for all
  applications and services running in a Mesos cluster. These features combined
  lets you program against your datacenter like it's a single pool of resources,
  a useful tool when building highly scalable applications stacks.
---
