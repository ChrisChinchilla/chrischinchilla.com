...
![A screenshot showing WordCounter's accessibility settings](articles/1*V4LusgQz8XjWuVdrktPj4A.webp)

![A screenshot showing WordCounter's login settings](articles/1*cq3HIBFXNdv_rMHfijmx9Q.webp)
...
![A screenshot of adding an application for WordCounter to track](articles/1*StgPE0QKkMOWm96uUFCFCQ.webp)
...
![A screenshot showing the WordCounter setting for file types](articles/1*dWV9iH0XqtMwLY9HoAc8RA.webp)
